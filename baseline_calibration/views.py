...
def calibrate2(request,id):
    ...
    # pillar_survey_update = PillarSurveyUpdateForm(instance=qs)
    ...
    # EDM_ObservationFormset = formset_factory(EDM_ObservationForm, extra=0)
